...
public class NVPAPICaller
{
    ...
    public string APIUsername = "amondarthir-facilitator_api1.gmail.com";
    private string APIPassword = "SCB3SQJKT84TEZXD";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31Ab1ZCh2X2mbwh.XSZCR6t5FyNKF6";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "Windtip Toys Sample Application";
